...
if(APPLE)
  # As of 3.19.2, cmake's FindOpenGL does not link to the directory containing
  # gl.h. cmake bug? Intended due to missing subdir GL/gl.h?
...
if(WIN32)
  if(EXISTS "${PROJECT_SOURCE_DIR}/opencpn-libs/WindowsHeaders")
    ...
    message(
      STATUS "WARNING: WindowsHeaders library is missing, OpenGL unavailable")
  endif()
endif()
