...
#ifndef _SIMPLEPOSITIONINSTRUMENT_H
#define _SIMPLEPOSITIONINSTRUMENT_H
...
// Default palette
#define DSK_SPI_COLOR_TITLE_BG wxColor(130, 149, 75)
#define DSK_SPI_COLOR_TITLE_FG wxColor(255, 239, 130)
#define DSK_SPI_COLOR_BODY_BG wxColor(230, 230, 230)
#define DSK_SPI_COLOR_BODY_FG wxColor(15, 15, 15)
...
class SimplePositionInstrument : public Instrument {
...
protected:
    ...
    /// Active format
    Instrument::position_format m_format;
...
public:
    ...
    explicit SimplePositionInstrument(Dashboard* parent)
        : Instrument(parent)
    {
        Init();
    };
    ...
    {
        return SimplePositionInstrument::Class();
    };
    ...
    static wxString Class() { return "SimplePositionInstrument"; };
    ...
    {
        return SimplePositionInstrument::DisplayType();
    };
...
#endif //_SIMPLEPOSITIONINSTRUMENT_H
