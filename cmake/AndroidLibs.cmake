...
set_property(
  TARGET ${PACKAGE_NAME} PROPERTY IMPORTED_LOCATION
                                  ${CMAKE_BINARY_DIR}/lib${PACKAGE_NAME}.so)

# Make sure we have downloaded and unpacked master.zip
set(OCPN_ANDROID_CACHEDIR
...
if(NOT EXISTS ${OCPN_ANDROID_CACHEDIR}/master.zip)
  file(
    DOWNLOAD https://github.com/bdbcat/OCPNAndroidCommon/archive/master.zip
